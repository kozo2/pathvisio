...
public abstract class GmmlVision {
	...
	public static void openPathway(String pwf)
	{
		...
		if(_gmmlData != null) //Only continue if the data is correctly loaded
		{
			...
			firePropertyChange(new ApplicationEvent(drawing, ApplicationEvent.OPEN_PATHWAY));
		}
	...
	public static void newPathway() {
		...
		firePropertyChange(new ApplicationEvent(drawing, ApplicationEvent.NEW_PATHWAY));
	}
	 ...
	 * @param e
	 */
	public static void firePropertyChange(ApplicationEvent e) {
