...
//Program code: tryout 
  ...
  int[][] coord={{500,300},{500,200},{400,300},{520,300},{500,400}};
  int[][] link={{1,2},{1,3},{1,4},{1,5}};
  ...
  int refL = 15;     //For this coord: attraction
  int alpha = 1;		//Equation used: (nLinks[nRow]+1)*(nLinks[nColumn]+1)*(alpha/(distanceSquare[nRow][nColumn])
