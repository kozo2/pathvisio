...
public class Rectangles2 extends Applet{
	...
	//An applet is opened.
	Applet applet = new Rectangles2();
	f.add("Center", applet); //Frame is put in the middle of the applet.
	applet.init(); //init is applied on applet: Borderlayout, RectangleCanvas2 and a label are added.
...
//a new class RectangleCanvas2, which extends Canvas, is created.
class RectangleCanvas2 extends Canvas implements MouseListener, MouseMotionListener{
   ...
   Rectangle area;
	...
	public RectangleCanvas2(){ //method to color the rectangle
	...
	public void mousePressed(MouseEvent e){
      ...
      // Checks whether or not the cursor is inside of the rectangle while the user is pressing the mouse.
		...
		Rectangles2.label.setText("First position the cursor on the rectangle and then drag.");
			pressOut = true;
			rect1click=false;
			rect2click=false;
		}
	...
	public void updateLocation1(MouseEvent e){
		...
		rect1.setLocation(last1_x + e.getX(), last1_y + e.getY());
                ...
                if (checkRect1()) { //true if rect1 is in area, false if rect1 is not in area, rect1 is put back intro area
                    Rectangles2.label.setText("Rectangle 1 located at " +
                                                     rect1.getX() + ", " +
                                                     rect1.getY());
                } else {
                    Rectangles2.label.setText("Please don't try to "+
...
public void updateLocation2(MouseEvent e){
		...
		rect2.setLocation(last2_x + e.getX(), last2_y + e.getY());
                ...
                if (checkRect2()) { //true if rect2 is in area, false if rect2 is not in area, rect2 is put back intro area
                    Rectangles2.label.setText("Rectangle 2 located at " +
                                                     rect2.getX() + ", " +
                                                     rect2.getY());
                } else {
                    Rectangles2.label.setText("Please don't try to "+
